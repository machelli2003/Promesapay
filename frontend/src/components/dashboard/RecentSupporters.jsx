  ...
  return (
    <div className="card">
      <h3 className="font-bold mb-4 flex items-center gap-2">
        <FiHeart className="h-4 w-4 text-red-400 fill-red-400" />
        Recent Supporters
      </h3>
      <div className="space-y-3">
        {transactions.slice(0, 6).map((txn) => (
          <div key={txn.id}
            ...
            {/* Avatar */}
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-sky-400 to-blue-500 flex items-center justify-center text-white text-xs font-bold shrink-0">
            ...
            <div className="text-right shrink-0">
              <p className="font-bold text-sm text-sky-600 dark:text-sky-400">{formatCurrency(txn.amount)}</p>
