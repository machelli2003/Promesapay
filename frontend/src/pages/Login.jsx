    ...
    <div className="min-h-screen grid lg:grid-cols-[1fr_480px]">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-slate-900 px-12 py-10">
        ...
        <div className="space-y-3 max-w-sm">
          ...
          {[
            { name: "Ama Owusu",    role: "Visual Artist",  raised: "GH₵8,750", quote: "I funded my entire studio through Promesapay. Setup took 4 minutes." },
            ...
            <div key={t.name} className="border border-slate-700 bg-slate-800 rounded-xl p-4 space-y-3">
        ...
        <div className="w-full max-w-sm animate-slide-up">
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white dark:bg-slate-950 px-3 text-xs text-slate-400">or sign in with email</span>
            </div>
          </div>
